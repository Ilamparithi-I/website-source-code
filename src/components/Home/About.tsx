    ...
    return (
        <div>
            ...
            <p className="text-green-400 leading-relaxed mt-4">
                ...
                volunteer as a Tech Team Manager at the Gal Senior Care
                Foundation, leading efforts to protect seniors from scams, and I
                also contribute to sustainability by repairing small electronics
                at repair cafes. I believe in using my skills to make a
                meaningful impact while continuously learning and growing in
